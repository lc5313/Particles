...
int main(void)
{
    ...
    ParticleSystem pSystem(1000, shader, vb, ib, layout);
    pSystem.init(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec4(0.0f, 0.2f, 1.0f, 1.0f), 0.01f, 0.7f, glm::vec3(0.25f, 0.25f, 0.25f));
    ...
    while (!glfwWindowShouldClose(window))
    {
     ...
     /*   ImGui_ImplOpenGL3_NewFrame();
      ...
      /*  {
        ...
        //shader.bind();
        //pSystem.setSpawn(translation);
        pSystem.spawnParticle();
        pSystem.onUpdate();
        pSystem.onRender();
